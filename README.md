...
![tickrs](https://repo.x-cmd.io/tickrs.svg)
...
Total: **6,003** lines of code across **40** files in the top 5 languages.
...
- **Upstream**: <https://github.com/tarkah/tickrs>
- **License**: MIT
...
- **Stars**: 1,693 · **Forks**: 99 · **Open issues**: 81 · **Contributors**: 12

## Totals (cumulative)

- **Releases**: 35 · **Merged PRs**: 75 · **Open PRs**: 4 · **Closed issues**: 52 · **Open issues**: 29 · **Commits**: 208
...
Reported by **17** distros on [repology.org](https://repology.org/project/tickrs). **12** are ✅ on the latest upstream release, **4** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T02:27:11Z._
